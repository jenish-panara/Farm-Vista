      ...
      const handlesubmit=async(e)=>{
        ...
        try {
            ...
            if (u1.fields.email===info.email){
                // navigate('/home')
                navigate(`/admin/home?username=${encodeURIComponent(u1.fields.name)}&email=${encodeURIComponent(u1.fields.email)}`);
            }
            } 
            catch (error) {
        ...
        <div className="">
            <div className="auth-container" >
                <div className="welcome-section">
                    ...
                    <button onClick={() =>{navigate('/admin/signup')}} className='button1'>Sign Up</button>
                </div>
                <div className="login-section">
                    <h2>Sign In</h2>
                    <form onSubmit={handlesubmit} className='form1'>
                        <label for="Email" className='label1'>Admin Email</label>
                    ...
                    <p className='p1'>Don't have an account? <a className='a1' href="/admin/signup">Sign Up</a></p>
                </div>
            </div>
        </div>
